...
MODEL_PATH="${PILOT_MODEL_PATH:-Qwen/Qwen3-8B}"
SERVED_MODEL="${PILOT_SERVED_MODEL:-Qwen/Qwen3-8B}"
...
PILOT_VLLM_DEFAULT_CHAT_TEMPLATE_KWARGS="${PILOT_VLLM_DEFAULT_CHAT_TEMPLATE_KWARGS:-{\"enable_thinking\": false}}"
...
if [[ -n "${PILOT_VLLM_DEFAULT_CHAT_TEMPLATE_KWARGS:-}" ]]; then
