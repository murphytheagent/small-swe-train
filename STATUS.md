...
- Monitor queued preflight matrix `3032`-`3039` for runtime health and results. JSON remains the default contract unless matched JSON-vs-XML evidence says otherwise; XML is an explicit opt-in config for this comparison.
